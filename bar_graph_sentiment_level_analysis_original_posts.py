...
# Load the data
df = pd.read_csv('original_posts_sentiment_analysis_level4/conversation_original_posts_sentiment_level4.csv')
...
ax.set_title('Median Sentiment Levels in Original Posts by Conversation Type', fontsize=14, fontweight='bold')
ax.set_xticks(x_pos)
...
plt.savefig('graphs/original_posts_median_sentiment_ratios_grouped_bar_chart.png', dpi=300, bbox_inches='tight')
print("Chart saved as: graphs/original_posts_median_sentiment_ratios_grouped_bar_chart.png")
