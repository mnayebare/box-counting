...
df = pd.read_csv('fractal_dimension_replies_analysis.csv')
...
keyword_df.to_csv('keyword_extraction_results.csv', index=False)
print("Keyword extraction results saved to 'keyword_extraction_results.csv'")
